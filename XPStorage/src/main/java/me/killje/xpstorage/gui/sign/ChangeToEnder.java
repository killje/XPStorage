...
public class ChangeToEnder implements GuiElement{
    ...
    public ItemStack getItemStack() {
        ...
        if (isSelected) {
            return createSimpleItemStack(Material.STAINED_GLASS_PANE, ChatColor.YELLOW + "Currently selected:" + ChatColor.WHITE + " Player sign", lore);
        }
        return createSimpleItemStack(Material.ENDER_CHEST, ChatColor.WHITE + "Player sign", lore);
    }
