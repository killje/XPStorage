...
public class ChangeToNormal implements GuiElement{
    ...
    public ItemStack getItemStack() {
        ...
        if (isSelected) {
            return ItemStackFromFile.getItemStack("selected.normal", ChatColor.YELLOW + "Currently selected:" + ChatColor.WHITE + " Location sign", lore);
        }
        return ItemStackFromFile.getItemStack("changeToNormal", ChatColor.WHITE + "Location sign", lore);
    }
